defmodule Blog.Accounts do
  ...
  @doc """
  Returns a changeset for live-validating a registration form.
  Password hashing is disabled so it is fast enough for keystroke-level feedback.
  """
  ...
  ## Examples
      ...
      iex> register_user(%{email: "x@y.com", password: "...12 chars..."})
      {:ok, %User{}}
  ...
  See `Blog.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Blog.Accounts.User.password_changeset/3` for a list of supported options.
